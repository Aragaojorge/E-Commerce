...
class UserForm(forms.ModelForm):
    ...
    def clean(self, *args, **kwargs):
        ...
        error_msg_email_exists = 'Email already in use!'
        error_msg_password_match = 'Passwords do not match!'
        error_msg_password_length = 'At least 6 characters required!'
        error_msg_required_field = 'Please fill out this field!'
        ...
        if self.user:
            ...
            if password_data:
                ...
                if len(password_data) < 6:
                    validation_error_messages['password'] = error_msg_password_length
